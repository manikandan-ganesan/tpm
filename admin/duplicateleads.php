                    ...
                    <div class="row">
                            <div class="col-sm-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Duplicate Leads Details</h4>
                                </div>
                            </div> 
                            <div class="col-sm-4 text-right">
                                <a href="leads-details.php" class="mt-3 btn btn-primary text-white"> Leads Details</a>
                                <a href="leadsexport.php" class="mt-3 btn btn-primary text-white"> Export To Excel </a>
                            </div>                          
                        </div>
                            <div class="row mb-3">
                                <div class="col-xl-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                             ...
                                             <?php
                                            global $db;
                                            $query = "SELECT * FROM dupleads Where tempDelete ='n'";                                            
